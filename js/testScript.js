...
nextButton.addEventListener('click', () => { 
    if (currentPage < pageCount) {
        currentPage++;
        getMusicGroups(); // anropar metoden för att fylla listan med ny data 
    }
});
...
// Eventlistener som lyssnar efter attt dom-trädet är uppbyggt och sedan anropar metoden för att hämta data från api
